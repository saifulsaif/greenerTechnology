    ...
    <div class="box-widget widget-module">
        ...
        <div class="widget-container">
          ...
          ?>
                ...
                <form class="form-horizontal" action="<?php echo base_url()?>super_admin/update_about" enctype="multipart/form-data" method="post">
                    <div class="form-group">
                        <label class="col-md-2 control-label">About photo *</label>
                        <div class="col-md-4">
                           
                            <input type="file" class="form-control" name="photo">
                            <br>   <img class="card-img-top img-fluid" height="100px" width="120px;" src=" <?php echo $about_info->photo;?>" alt="Card image cap">
                  
                          
                            <input type="hidden" class="form-control" value="<?php echo $about_info->about_id;?>" name="about_id">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-4">
                            ...
                            <textarea name="title" value="<?php echo $about_info->about_title   ;?>" class="form-control" rows="2" cols="11">
<?php echo $about_info->about_title;?>
                             </textarea>
                        </div>
                    ...
                    <div class="form-group">
                      ...
                      <label class="col-md-2 control-label">About Information Upper</label>
                        <div class=" col-md-9">
                            <textarea name="about" value="<?php echo $about_info->about;?>" class="form-control" rows="12">
<?php echo $about_info->about;?>
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-4">
                            ...
                            <textarea name="title1" value="<?php echo $about_info->title1   ;?>" class="form-control" rows="2" cols="11">
<?php echo $about_info->title1;?>
                             </textarea>
                        </div>
                    ...
                    <div class="form-group">
                      ...
                      <label class="col-md-2 control-label">About Information Lower</label>
                        <div class=" col-md-9">
                            <textarea name="about1" value="<?php echo $about_info->about1;?>" class="form-control" rows="7">
<?php echo $about_info->about1;?>
                             </textarea>
