    ...
    <div class="box-widget widget-module">
        ...
        <div class="widget-container">
          ...
          ?>
                ...
                <form class="form-horizontal" action="<?php echo base_url()?>super_admin/update_contact" enctype="multipart/form-data" method="post">
                   <div class="form-group">
                        <label class="col-md-2 control-label">Address *</label>
                        <div class="col-md-4">
                           
                            <input type="text" value="<?php echo $contact_info->address;?>" class="form-control" name="address">
                            <input type="hidden" value="<?php echo $contact_info->contact_id;?>" class="form-control" name="contact_id">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" value="<?php echo $contact_info->number;?>" class="form-control" name="number">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" value="<?php echo $contact_info->email;?>" name="email">
                    ...
                    <div class="form-group">
                      ...
                      <label class="col-md-2 control-label">Contact Details</label>
                        <div class=" col-md-9">
                            <textarea name="details" value="<?php echo $contact_info->details;?>" class="form-control" rows="6">
                           <?php echo $contact_info->details;?>
                            </textarea>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" value="<?php echo $contact_info->facebook;?>" name="facebook">
                  ...
                  <div class="form-group">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" value="<?php echo $contact_info->twitter;?>" name="twitter">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" value="<?php echo $contact_info->youtube;?>" name="youtube">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" value="<?php echo $contact_info->instagram;?>" name="instagram">
