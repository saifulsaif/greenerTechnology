        ...
        <div class="widget-container">
            <div class=" widget-block">
                <div class="page-header">
                    <h2>Update Testimonial Information</h2>
                     <h4 style="color:red;">
          <?php 
          ...
          ?>
                ...
                <form class="form-horizontal" action="<?php echo base_url()?>super_admin/update_testimonial" enctype="multipart/form-data" method="post">
                   <div class="form-group">
                        <label class="col-md-2 control-label">Name *</label>
                        <div class="col-md-4">
                           
                            <input type="text" value="<?php echo $testimonial_info->name;?>" class="form-control" name="name">
                            <input type="hidden" value="<?php echo $testimonial_info->testimonial_id;?>" class="form-control" name="testimonial_id">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" value="<?php echo $testimonial_info->designation;?>" class="form-control" name="designation">
                    ...
                    <div class="form-group">
                      ...
                      <label class="col-md-2 control-label">Testimonial Details</label>
                        <div class=" col-md-9">
                            <textarea name="details" value="<?php echo $testimonial_info->details;?>" class="form-control" rows="6">
                           <?php echo $testimonial_info->details;?>
                            </textarea>
