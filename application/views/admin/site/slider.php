    ...
    <div class="box-widget widget-module">
        ...
        <div class="widget-container">
          ...
          ?>
                ...
                <form class="form-horizontal" action="<?php echo base_url()?>super_admin/save_slider" enctype="multipart/form-data" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <label class="col-md-2 control-label"> Title for green</label>
                        <div class=" col-md-9">
                    ...
                    <div class="form-group">
                      ...
                      <label class="col-md-2 control-label"> note </label>
                        <div class=" col-md-9">
                            <textarea name="details1" class="form-control" rows="2">
                             </textarea>
