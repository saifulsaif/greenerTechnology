    ...
    <div class="box-widget widget-module">
        ...
        <div class="widget-container">
          ...
          ?>
                ...
                <form class="form-horizontal" action="<?php echo base_url()?>super_admin/save_partner" enctype="multipart/form-data" method="post">
                    <div class="form-group">
                        <label class="col-md-2 control-label">Parner Logo *</label>
                        <div class="col-md-4">
