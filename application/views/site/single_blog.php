...
<body>
    ...
    <!--Header End-->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 text-center breadsec">
                        <h1 class="breadTitle">Single Blog</h1>
        ...
        <section class="servicesDetails">
            <div class="container">
                <?php foreach($all_single_blog as $blog) { ?> 
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12 ">
                        <figure class="serdetaImg">
                            <img src="<?php echo $blog->photo;?>" alt="slider_img"/>
                        </figure>
                    </div>
                    <div class="col-md-12 col-sm-12 col-xs-12">
                     <div class="sblogDec">
                        ...
                        <p class="text-left"><?php echo $blog->details;?> </p>
